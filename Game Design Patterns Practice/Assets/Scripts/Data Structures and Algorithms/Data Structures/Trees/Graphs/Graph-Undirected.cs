...
namespace GraphsUndirected
{
    class Graphs
    {
        ...
        {
            Graphs g = new Graphs(4); //create an adjacency matrix with 4 nodes (4 rows, 4 columns)
            ...
            //create all edges
            g.insertEdge(0, 1, 1); //x = the cost/weight. x is 1 because this is an unweighted undirected graph
            g.insertEdge(0, 2, 1);
            g.insertEdge(1, 0, 1);
            g.insertEdge(1, 2, 1);
            g.insertEdge(2, 0, 1);
